...
class VoronoiWallpaperService : WallpaperService() {
    ...
    Dispatchers.Main +
        ...
        // Separate scope for preferences
        ...
        private var numPoints = 53
        private var drawPoints = true
        private var pixelStep = 3
        private var useSpatialGrid = false
...
//                        initializePoints()
                    ...
                    Log.e(TAG, "Preference init failed", e)
                    // Proceed with defaults
                }
            }
        }

        private fun applySettings(settings: VoronoiSettings) {
...
//            initializePoints()
        ...
        private fun initializeSurfaceResources() {
            ...
            framePool = Array(2) {
                createBitmap(
                    ...
                    // Track bitmap allocation
                        bitmap ->
                    metricsLogger.onBitmapAllocated(bitmap)
...
//            }
        ...
        // Modify your initialization to use settings
        private suspend fun loadPreferences() {
            try {
                val prefs = VoronoiPreferences(applicationContext)
                // Get the first value immediately (don't use collect here)
                ...
                Log.d("Prefs", "Loaded settings: $settings")
            } catch (e: Exception) {
